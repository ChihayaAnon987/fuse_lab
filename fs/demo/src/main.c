...
// # define S_IFDIR	__S_IFDIR // 目录文件
// # define S_IFCHR	__S_IFCHR // 字符设备文件
// # define S_IFBLK	__S_IFBLK // 块设备文件
// # define S_IFREG	__S_IFREG // 普通文件
/* 显示文件属性 */
static int demo_getattr(const char* path, struct stat *stbuf)
{
    if(strcmp(path, "/") == 0)
        ...
        stbuf->st_mode = DEMO_DEFAULT_PERM | S_IFREG;            // TODO: 该文件显示为普通文件
    return 0;
}
